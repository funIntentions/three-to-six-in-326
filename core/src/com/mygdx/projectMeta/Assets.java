...
//        grabTexture = loadTexture("images/grabV1.png");
        ...
        bed = new TextureRegion(bedTexture, bedTexture.getWidth(), bedTexture.getHeight());
        portal = new TextureRegion(portalTexture, portalTexture.getWidth(), portalTexture.getHeight());
